...
data = pd.read_csv(r'C:\Users\Sunjeevi\PycharmProjects\NewBankingFraudTransaction\.venv\UNewBankingFraud\Dataset\cleaned_data.csv')
...
model = joblib.load(r'C:\Users\Sunjeevi\PycharmProjects\NewBankingFraudTransaction\.venv\UNewBankingFraud\ModelFiles\trans_fraud.pkl')
